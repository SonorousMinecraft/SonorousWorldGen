...
public class SavannaPlateau extends BiomeRepresentation implements TreeBiome, FloraBiome {
    ...
    private static final HashMap<BiomeLayers, List<Material>> layers = new HashMap<>() {{
        put(BiomeLayers.SURFACE, List.of(Material.RED_CONCRETE));
        put(BiomeLayers.PRIMARY, List.of(Material.DIRT));
        put(BiomeLayers.SECONDARY, Arrays.asList(Material.COAL_ORE, Material.IRON_ORE, Material.REDSTONE_ORE, Material.LAPIS_ORE, Material.GOLD_ORE, Material.DIAMOND_ORE));
        put(BiomeLayers.BASE, List.of(Material.BEDROCK));
    }};
    public SavannaPlateau() {
        super(org.bukkit.block.Biome.SAVANNA_PLATEAU, "Savanna Plateau", layers, 0.6, 0.8, -0.3, BiomeCategories.ARID);
    }
